...
echo "                <span id=\"rare-count\" class=\"monster-count-label rare\"></span> <span id=\"normal-count\" class=\"monster-count-label normal\"></span>  <span id=\"total-catch-count\" class=\"monster-count-label normal\"></span> <span id=\"unfound-count\" class=\"monster-count-label unfound\"></span>";
echo "            </div>";
echo "            <div class=\"col-12\">";
echo "                <span>";
...
echo "                        <p id=\"ownerListText\" class=\"monster-owner-text normal\">Some text in the modal.</p>";
echo "                    </div>";
